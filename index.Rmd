...
Self guided resources that cover everything from creating a data management plan, to naming conventions, recommended file formats and how to handle storage of common data types.
</button>
</a>
